...
class PaymentServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        shortcode()->setAdminConfig('payment-form', view('plugins/payment::partials.payment-form-admin-config')->render());
        ...
        shortcode()->setAdminConfig('payment-info', view('plugins/payment::partials.payment-info-admin-config')->render());
    }
}
