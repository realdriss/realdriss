...
<body <?php if(BaseHelper::adminLanguageDirection() == 'rtl'): ?> dir="rtl" <?php endif; ?> class="<?php echo $__env->yieldContent('body-class', 'page-sidebar-closed-hide-logo page-content-white page-container-bg-solid'); ?>" style="<?php echo $__env->yieldContent('body-style'); ?>">
...
<?php /**PATH C:\xampp\htdocs\projects\realdriss-hook\core\platform/core/base/resources/views//layouts/base.blade.php ENDPATH**/ ?>