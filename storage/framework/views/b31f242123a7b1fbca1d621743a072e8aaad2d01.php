        ...
        <div class="portlet-title">
            <div class="caption">
                <div class="wrapper-action">
                    <?php if($actions): ?>
                        <div class="btn-group">
                            <a class="btn btn-secondary dropdown-toggle" href="#" data-toggle="dropdown"><?php echo e(trans('core/table::table.bulk_actions')); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\realdriss-hook\core\platform/core/table/resources/views//base-table.blade.php ENDPATH**/ ?>