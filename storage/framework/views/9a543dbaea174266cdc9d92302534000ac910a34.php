        ...
        <div class="product_img">
            <a href="<?php echo e($product->url); ?>">
                ...
                <?php if(isset($product->images[1])): ?>
                    <img class="product_hover_img" src="<?php echo e(RvMedia::getImageUrl($product->images[1], 'medium', false, RvMedia::getDefaultImage())); ?>" alt="<?php echo e($product->name); ?>">
                <?php endif; ?>
            </a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\projects\realdriss-hook\core\platform/themes/shopwise/partials/product-item.blade.php ENDPATH**/ ?>